(module
  ...
  (type (;3;) (func (param f32 f32 f32 f32 f32 f32 f32 f32 f32 f32) (result i32)))
  (type (;4;) (func (param f32 i32) (result i32)))
  (func (;0;) (type 2) (param f64 i32) (result f64)
    block  ;; label = @1
      local.get 1
      i32.const 1024
      i32.ge_s
    ...
    f64.reinterpret_i64
    f64.mul)
  (func (;1;) (type 3) (param f32 f32 f32 f32 f32 f32 f32 f32 f32 f32) (result i32)
    (local f32 f32 f32 f32 f32 f32 f32 v128 v128 v128 v128 v128 v128 v128 v128 i32 i32 i32)
    local.get 4
    f32.abs
    ...
    block  ;; label = @1
      ...
      local.get 20
      i8x16.shuffle 0 1 2 3 4 5 6 7 20 21 22 23 0 1 2 3
      local.get 17
      ...
      local.get 20
      i8x16.shuffle 0 1 2 3 4 5 6 7 28 29 30 31 0 1 2 3
      local.get 17
  ...
  (func (;4;) (type 1) (param f64) (result f32)
    ...
    f64.add
    f32.demote_f64)
  (func (;5;) (type 1) (param f64) (result f32)
    (local f64)
    local.get 0
    local.get 0
    f64.mul
    ...
    f64.add
    f32.demote_f64)
  (func (;6;) (type 4) (param f32 i32) (result i32)
